...
import { CadFileManager } from "@/components/cad/cad-file-manager"
import { Crown, Sparkles, Gem, Box, FileText, Settings, RefreshCw, ArrowLeft, TrendingUp, Clock, CheckCircle, AlertCircle, Target, BarChart3, Plus, Users, Calendar, Star, Heart, DollarSign, ShoppingBag, Zap, Award, Globe, Briefcase, Database, Warehouse, Diamond, Circle, Square, Hexagon, Download, Upload, Eye, Edit, Trash2, Folder, File, Search, Filter } from "lucide-react"
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-lg font-medium">Organize, view, and track your jewelry design files</p>
                  </div>
                </div>
