      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-12 max-w-4xl w-full">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight bg-gradient-to-r from-emerald-700 to-emerald-900 bg-clip-text text-transparent mb-2 customer-heading">
              New Customer
            </h1>
          </div>
        </div>
