...
const locations = [
  ...
  { label: "Main Workshop", value: "main-workshop" },
  { label: "North Studio", value: "north-studio" },
  { label: "South Studio", value: "south-studio" },
  { label: "East Workshop", value: "east-workshop" },
]

export function EfficiencyFilters({ filters, setFilters }: { filters: any; setFilters: any }) {
  return (
