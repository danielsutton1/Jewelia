...
import { productionMetricsSchema, dateRangeSchema, validateDateRange } from '@/lib/validations/analytics'
...
async function GET(req: NextRequest) {
  try {
    ...
    const craftspersonId = searchParams.get('craftspersonId')
    ...
    if (craftspersonId) {
      query = query.eq('craftsperson_id', craftspersonId)
    }
...
async function POST(req: NextRequest) {
  try {
    ...
    const validatedData = productionMetricsSchema.parse(body)
