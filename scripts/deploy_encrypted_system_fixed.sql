-- 🚀 FIXED DEPLOYMENT: ENCRYPTED COMMUNICATION SYSTEM
-- This script handles missing dependencies and creates all required tables

-- =====================================================
-- 0. CREATE MISSING DEPENDENCY TABLES
-- =====================================================
...
-- Add encryption fields to existing messages table if they don't exist
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'messages' AND column_name = 'encryption_version') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'messages' AND column_name = 'content_hash') THEN
...
COMMENT ON TABLE messages IS 'Base table for individual messages';
