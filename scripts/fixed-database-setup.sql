-- =====================================================
-- FIXED DATABASE SETUP (CORRECTED SYNTAX)
-- =====================================================
-- This script creates all necessary tables and populates them with sample data
-- WITHOUT modifying the auth.users table and with correct PostgreSQL syntax
...
-- =====================================================
-- 4. ADD FOREIGN KEY CONSTRAINTS (CORRECTED SYNTAX)
-- =====================================================
...
BEGIN
    ...
    BEGIN
        ALTER TABLE message_threads DROP CONSTRAINT IF EXISTS message_threads_organization_id_fkey;
        ALTER TABLE message_threads ADD CONSTRAINT message_threads_organization_id_fkey 
    ...
    BEGIN
        ALTER TABLE message_threads DROP CONSTRAINT IF EXISTS message_threads_department_id_fkey;
        ALTER TABLE message_threads ADD CONSTRAINT message_threads_department_id_fkey 
    ...
    BEGIN
        ALTER TABLE message_threads DROP CONSTRAINT IF EXISTS message_threads_related_order_id_fkey;
        ALTER TABLE message_threads ADD CONSTRAINT message_threads_related_order_id_fkey 
    ...
    BEGIN
        ALTER TABLE message_threads DROP CONSTRAINT IF EXISTS message_threads_related_project_id_fkey;
        ALTER TABLE message_threads ADD CONSTRAINT message_threads_related_project_id_fkey 
    ...
    BEGIN
        ALTER TABLE messages DROP CONSTRAINT IF EXISTS messages_related_order_id_fkey;
        ALTER TABLE messages ADD CONSTRAINT messages_related_order_id_fkey 
        FOREIGN KEY (related_order_id) REFERENCES orders(id) ON DELETE SET NULL;
    EXCEPTION WHEN OTHERS THEN
        -- Constraint might not exist, continue
    END;
    ...
    BEGIN
        ALTER TABLE messages DROP CONSTRAINT IF EXISTS messages_related_task_id_fkey;
        ALTER TABLE messages ADD CONSTRAINT messages_related_task_id_fkey 
    ...
    BEGIN
        ALTER TABLE messages DROP CONSTRAINT IF EXISTS messages_related_project_id_fkey;
        ALTER TABLE messages ADD CONSTRAINT messages_related_project_id_fkey 
        FOREIGN KEY (related_project_id) REFERENCES projects(id) ON DELETE SET NULL;
    EXCEPTION WHEN OTHERS THEN
        -- Constraint might not exist, continue
    END;
